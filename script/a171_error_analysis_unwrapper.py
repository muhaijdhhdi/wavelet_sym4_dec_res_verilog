...
# 1. 全局配置与系数
# ==========================================
def a171_error_analysis(COEF_FRAC = 23,DATA_WIDTH = 16,DATA_INTERNAL_WIDTH = 48,NUM_TEST_CYCLES = 2000,x_input_path = "D:/project/zu9_modifield+pulse_iir/PL/FMC_FH8052_zu9/FMC_FH8052.srcs/sources_1/imports/src/simulation/x_input.txt"):
    ...
    # 重新推导相关参数以防后续代码使用
    TOTAL_SAMPLES = len(ideal_data_input)
    ...
    # 定义辅助函数进行重复的读取和比较工作
    def analyze_rec_stage(stage_label, filename, python_data,front_disp=5,base_or_not=False,start=0,print_error="no"):
    ...
    analyze_rec_stage("Res_L_1-> baseLine","base_output.txt",final_baseline_rec,front_disp=20,base_or_not=True,print_error="yes")
    ...
    calculate_snr("Rec_L1 (base)", "base_output.txt", final_baseline_rec, base_or_not=True, start=0)
    print("=" * 60)