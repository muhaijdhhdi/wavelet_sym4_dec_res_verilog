`timescale 1ns / 1ps
//////////////////////////////////////////////////////////////////////////////////
// Module: pulse_counter_ultra_v3
// Description: 高性能脉冲计数模块（增强版 v3，支持脉冲堆积检测）
//
// v3 改进：
...
//   6. 跨周期配对支持（最多4个周期）
//   7. 流水线设计，时序友好
//   8. pending 快速更新（1周期），解决连续脉冲堆积问题
//
// 子模块：
//   - zeropoints_mask_v2：过零点掩码生成（含方向信息）
//   - zeropoints_analysis_v3：零点分析器（含ones_mate_v3配对逻辑）
//
// 输入：
...
//
// 流水线延迟：约14个时钟周期
//   zeropoints_mask_v2: 3 + zeropoints_analysis_v3: 10-11
//////////////////////////////////////////////////////////////////////////////////
