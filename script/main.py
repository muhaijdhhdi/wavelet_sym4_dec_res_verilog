...
from hw_vs_sw import hw_vs_sw
from a171_error_analysis import a171_error_analysis
...
if __name__ == "__main__":
    ...
    x_gen(seed=45, num_test_cycles=10000, amplitude=2000)
    ...
    a171_error_analysis(DATA_INTERNAL_WIDTH=40,COEF_FRAC=16)
